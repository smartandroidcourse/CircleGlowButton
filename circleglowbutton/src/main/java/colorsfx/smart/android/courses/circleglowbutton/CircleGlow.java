...
public class CircleGlow extends ImageView {
    ...
    public CircleGlow(Context context) {
        super(context);
        init(context, null);
    }

    public CircleGlow(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(context, attrs);
    }

    public CircleGlow(Context context, AttributeSet attrs, int defStyle) {
